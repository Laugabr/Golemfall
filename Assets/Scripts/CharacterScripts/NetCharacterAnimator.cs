...
public class NetCharacterAnimator : NetworkBehaviour
{
    ...
    {
        // 1. Si se mueve, salta o est� en dash, cancelamos variantes
        ...
        // 2. Si est� en medio de una animaci�n de ataque (usa el Tag "Attack" en el Animator)
    ...
    {
        // Solo enviamos el par�metro si es necesario (para ahorrar red)
